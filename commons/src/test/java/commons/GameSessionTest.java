...
public class GameSessionTest {
	...
	public void checkConstructor() {
		...
		assertSame(0, s.answerCounter);
	}

	@Test
	public void testAddPlayer() {
		GameSession s = new GameSession(Stream.of(SOME_PLAYER).collect(Collectors.toList()));
	...
	public void testEquals() {
		...
		var c = new GameSession(Stream.of(new Player("blahh")).collect(Collectors.toList()));
	...
	public void testToString() {
		var s = new GameSession(Stream.of(new Player("blah")).collect(Collectors.toList()));
		...
		assertTrue(str.contains("answerCounter=0"));
